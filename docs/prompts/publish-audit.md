...
Publish the Ars Magna Greatest Hits audit so I can move the anagrams on the Discover page between its sections. Read AGENTS.md and "Audit the Discover page" in docs/OPERATOR.md first. Change nothing in the repository.
