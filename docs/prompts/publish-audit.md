...
Publish the Ars Magna Greatest Hits audit so I can relabel the anagrams on the Greatest Hits page. Read AGENTS.md and "Audit the Greatest Hits page" in docs/OPERATOR.md first. Change nothing in the repository.
